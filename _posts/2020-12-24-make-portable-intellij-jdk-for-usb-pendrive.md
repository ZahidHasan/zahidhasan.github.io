...
4. Now download portable JDK made for portableapps platform [here](https://portableapps.com/apps/utilities/OpenJDK64)    or [here](https://tongxai-my.sharepoint.com/:u:/g/personal/zh_2002000_xyz/EfuXG0NbSeFPpfVNWBLMkZ0BfhS8dPUSTas0Sr7opZmcUA?e=soWHEv).
...
4. Now run IntelliJ, click configuration then `Structure for New Project`
   ![portable_intellij_configuration1.png]({{site.baseurl}}/images/portable_intellij_configuration1.png)

5. Click dropdown at `No SDK` and select `Add JDK`
   ![portable_intellij_configuration2.png]({{site.baseurl}}/images/portable_intellij_configuration2.png)

6. A new windows will open, locate `openJDK64` inside the `CommonFiles` folder in `PortableApps` folder at drive D.
